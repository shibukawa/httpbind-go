...
goals:
  ...
  - generated per-Bind definitions compose into TOML and .env scaffold output
...
acceptance:
  ...
  - public configbind APIs merge scaffold fields from framework and application definitions
